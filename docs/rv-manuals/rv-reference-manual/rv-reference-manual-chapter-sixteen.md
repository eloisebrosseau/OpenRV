...
| composite.inputAngularMaskPivotX | float | 1 | Value of the angular x pivot |
| composite.inputAngularMaskPivotY | float | 1 | Value of the angular mask y pivot |
| composite.inputAngularMaskAngleInRadians | float | 1 | Value of the angle in radians used for the angular mask |
